...
function showMore(i,o){var t=$("#"+i+" .block-text-limit-short").height();$("#"+i+" .block-text-limit-short").css("display","none"),$("#"+i+" .block-text-limit-long").css({display:"block",height:""+t}),$("#"+i+" .block-text-limit-long").animate({height:""+o},400),$("#"+i+" .show").remove(),$("#"+i).append('<div class="show" onclick="showLess(\''+i+"', '"+t+"')\">Скрыть</div>")}function showLess(i,o){var t=$("#"+i+" .block-text-limit-long").height();$("#"+i+" .block-text-limit-long").animate({height:o},400,function(){$("#"+i+" .block-text-limit-long").css("display","none"),$("#"+i+" .block-text-limit-short").css("display","block")}),$("#"+i+" .show").remove(),$("#"+i).append('<div class="show" onclick="showMore(\''+i+"', '"+t+"')\">Читать дальше</div>")}jQuery(document).ready(function(i){function o(){s=i(window).scrollTop(),e=s+i(window).height(),i("div").is(".animate-trigger")&&i(".animate-trigger").each(function(o,t){i(this).offset().top+150>s&&i(this).offset().top+150<e&&i(this).addClass("triggered-animation")}),i(window).width()>1020&&i("div").is(".parallax")&&i(".parallax").each(function(o,t){var e=(s-i(this).offset().top)/3+20;i(this).attr("style","background-position-y: "+e+"px")})}function t(o,t,s){if(i("#"+o).html().length>t){var e=i("#"+o).html(),s=i("#"+o).height(),l=e.substr(0,t);l+="...",i("#"+o).empty(),i("#"+o).append('<div class="block-text-limit-short">'+l+"</div>"),i("#"+o).append('<div class="block-text-limit-long">'+e+"</div>"),i("#"+o).append('<div class="show" onclick="showMore(\''+o+"', '"+s+"')\">Читать дальше</div>")}}var s=i(window).scrollTop(),e=s+i(window).height();o(),i(".additional-input-trigger").click(function(o){i(this).toggleClass("active");var t=i(this).closest("form");i(".additional-input",t).slideToggle(400)}),i("div").is(".block-text-limit")&&i(".block-text-limit").each(function(o,s){t(i(this).attr("id"),100)}),i(".must-have-example-slider").slick({infinite:!0,speed:500,fade:!0,arrows:!0,cssEase:"linear",draggalbe:!1,swipe:!1}),i(".must-have-next-slide").click(function(o){var t=i(this).parent();i(".slick-next",t).trigger("click")}),i(".image-popup-zoom").magnificPopup({type:"image",closeOnContentClick:!0,closeBtnInside:!1,fixedContentPos:!0,mainClass:"mfp-no-margins mfp-with-zoom",image:{verticalFit:!0},zoom:{enabled:!0,duration:300}}),i("div").is(".block-looks-sync-slider")&&i(".block-looks-sync-slider").each(function(o,t){i(".block-looks-sync-slider-top",this).attr("id"),i(".block-looks-sync-slider-bottom",this).attr("id");i(".block-looks-sync-slider-top",this).slick({slidesToShow:1,slidesToScroll:1,arrows:!1,infinite:!0,asNavFor:i(".block-looks-sync-slider-bottom",this)}),i(".block-looks-sync-slider-bottom",this).slick({slidesToShow:4,slidesToScroll:1,infinite:!0,asNavFor:i(".block-looks-sync-slider-top",this),focusOnSelect:!0,responsive:[{breakpoint:769,settings:{slidesToShow:3}},{breakpoint:481,settings:{slidesToShow:2}}]})}),i(".assortiment-slider-row").slick({slidesToShow:3,slidesToScroll:1,arrows:!0,infinite:!0,responsive:[{breakpoint:993,settings:{slidesToShow:2}},{breakpoint:769,settings:{slidesToShow:1}}]}),i(".popup-youtube").magnificPopup({disableOn:700,type:"iframe",mainClass:"mfp-fade",removalDelay:160,preloader:!1,fixedContentPos:!1}),baron({root:".baron",scroller:".baron__scroller",bar:".baron__bar",scrollingCls:"_scrolling",draggingCls:"_dragging"}).fix({elements:".header__title",outside:"header__title_state_fixed",before:"header__title_position_top",after:"header__title_position_bottom",clickable:!0}).controls({track:".baron__track",forward:".baron__down",backward:".baron__up"}),i("div").is(".review-text-wrapper")&&i(".review-text-wrapper").each(function(o,t){i(".review-text",this).height()>220&&i(".review-text",this).css("padding-right","25px")}),i(".reviews-slider").slick({slidesToShow:2,slidesToScroll:1,arrows:!0,infinite:!0,responsive:[{breakpoint:993,settings:{slidesToShow:1}},{breakpoint:769,settings:{arrows:!1,slidesToShow:1}}]}),i(window).scroll(function(i){o()})});